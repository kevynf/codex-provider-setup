...
export const setupSpec = {
  ...
  messages: {
    ...
    ModelPresetsAction: "Add model preset",
    ManualSetupAction: "Add custom provider",
    SwitchProviderAction: "Switch provider",
    RemoveProviderAction: "Remove provider",
    RestoreAction: "Restore",
    SelectOption: "Select an option",
    SwitchTitle: "Switch provider",
    NothingToSwitch: "No provider configured by this script was found.",
    NothingToRemove: "No inactive provider is available to remove.",
    ProviderListItem: "{0} - {1} - {2}",
    RemoveProviderTitle: "Remove provider",
    RemoveProviderConfirm: "Remove {0}",
    ProviderAdded: "Added provider: {0}",
    ProviderSwitched: "Switched provider: {0}",
    ProviderRemoved: "Removed provider: {0}",
    ManagedProviderMissing: "The managed provider is missing from config.toml: {0}",
    ManagedProviderModified: "The managed provider contains unrecognized settings and was not removed: {0}",
    ...
    BackupManifestInvalid: "The backup manifest is invalid.",
